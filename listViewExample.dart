...
class MyPage extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MyListView()._myListViewSepareted(context),
...
class MyListView extends StatelessWidget{
  ...
  Widget _myListViewSepareted(BuildContext context){
    final titles = [
      'alarm',
      'pics',
      'PDF collection',
    ...
    return ListView.separated(
      ...
      separatorBuilder: (context, int index) {
        ...
        itemBuilder: (BuildContext context, int index){
          return Card(
            child: ListTile(
              leading: const Icon(Icons.accessibility, size: 40, color: Colors.white),
